        ...
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8 text-center">
                ...
                <div class="p-6 bg-gray-50 rounded-xl shadow">
                    ...
                    <a href="mailto:info@bookingsystem.com" class="text-teal-600 hover:underline">info@bookingsystem.com</a>
                </div>
                ...
                <div class="p-6 bg-gray-50 rounded-xl shadow">
                    ...
                    <a href="tel:+1234567890" class="text-teal-600 hover:underline">+123 456 7890</a>
                </div>
            </div>
        </div>
    </section>
