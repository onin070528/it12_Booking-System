        ...
        <ul class="flex flex-col px-4 space-y-1">
            ...
            <li>
                <a href="{{ route('notifications.index') }}"
                   class="flex items-center {{ request()->routeIs('notifications.*') ? 'bg-[#93BFC7] text-white' : 'text-gray-700 hover:bg-gray-100' }} px-4 py-3 rounded-lg font-medium transition">
