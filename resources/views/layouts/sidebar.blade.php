...
<body class="bg-gray-100">
        ...
        <ul class="flex flex-col px-4 space-y-4">
            ...
            <li>
                <a href="{{ route('dashboard') }}"
                   class="flex items-center {{ request()->routeIs('dashboard') ? 'bg-[#93BFC7] text-white' : 'text-gray-700 hover:bg-gray-100' }} px-4 py-3 rounded-lg font-medium transition">
            ...
            <li>
                <a href="{{ route('home') }}"
                   class="flex items-center {{ request()->routeIs('home') ? 'bg-[#93BFC7] text-white' : 'text-gray-700 hover:bg-gray-100' }} px-4 py-3 rounded-lg font-medium transition">
            ...
            <li>
                <a href="{{ route('booking.create') }}"
                   class="flex items-center {{ request()->routeIs('booking.create') ? 'bg-[#93BFC7] text-white' : 'text-gray-700 hover:bg-gray-100' }} px-4 py-3 rounded-lg font-medium transition">
                    <i class="fas fa-file-alt mr-3"></i> Create Booking
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('payments.index') }}"
                   class="flex items-center {{ request()->routeIs('payments.*') ? 'bg-[#93BFC7] text-white' : 'text-gray-700 hover:bg-gray-100' }} px-4 py-3 rounded-lg font-medium transition">
            ...
            <li>
                <a href="{{ route('messages.index') }}"
                   class="flex items-center justify-between {{ request()->routeIs('messages.*') ? 'bg-[#93BFC7] text-white' : 'text-gray-700 hover:bg-gray-100' }} px-4 py-3 rounded-lg font-medium transition relative">
                    <div class="flex items-center">
    ...
    <script>
        // Update unread messages count (make it globally accessible)
